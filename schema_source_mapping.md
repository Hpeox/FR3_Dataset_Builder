...
| `/attrs/schema_version` | builder policy | Constant `"v0.2"` from `HDF5_schema.md`. | scalar | string | one value per HDF5 file | confirmed | Version `v0.2` adds required task metadata. |
